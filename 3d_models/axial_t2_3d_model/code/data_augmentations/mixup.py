...
def mixup(x1: torch.Tensor, y1: torch.Tensor, y2: torch.Tensor, y3: torch.Tensor, alpha: float = 1.0):
    ...
    return mixed_x1, target_a_1, target_b_1, target_a_2, target_b_2, target_a_3, target_b_3, lam
